...
;; Platform fee: 1.25% (125 basis points)
(define-constant PLATFORM-FEE u125)

;; Data Variables
(define-data-var last-token-id uint u0)        ;; Tracks most recently minted Token ID
(define-data-var total-fees uint u0)           ;; Tracks total fees collected
